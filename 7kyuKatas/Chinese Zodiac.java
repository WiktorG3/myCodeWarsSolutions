/*
The Chinese zodiac is a repeating cycle of 12 years, with each year being represented by an animal and its reputed attributes. The lunar calendar is divided into cycles of 60 years each, and each year has a combination of an animal and an element. 
...
public class Kata extends Arrays{
  public static String chineseZodiac(int year) {
    int offset = year - 1924;
    String animal = animals[offset % 12];
    String element = elements[(offset % 10) / 2];
